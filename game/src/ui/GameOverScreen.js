...
export class GameOverScreen {
  ...
  onMouseMove(e) {
    ...
    const buttonY = this.canvas.logicalHeight * 0.7;
    this.continueHovered = x >= this.canvas.logicalWidth / 2 - 100 && 
  ...
  render(ctx) {
    ...
    if (this.finalStats) {
      ...
      ctx.fillText(`Enemies Defeated: ${this.finalStats.kills || 0}`, this.canvas.logicalWidth / 2, this.canvas.logicalHeight * 0.5);
    }
